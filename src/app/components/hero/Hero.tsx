		...
		return (
			...
			>
				...
				>
					...
					<RevealFx speed="fast" delay={0.8} translateY={20} center fillWidth>
						<Flex gap="16" center>
							<Button href="#contact" size="m" variant="primary" suffixIcon="chevronRight">
								Kostenloses Gespräch
							</Button>
				...
				<TiltFx>
					<Column fill aspectRatio="16 / 9">
						<RevealFx speed="fast" delay={0.8} translateY={20} fillWidth aspectRatio="16 / 9">
							<OgCard
								ogData={{
									title: "LM Beauty | Wimpernstudio",
									description: "Einblick in ein aktuelles Projekt und eine maßgeschneiderte Lösung.",
